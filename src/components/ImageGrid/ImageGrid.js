...
//           {images.map(image => (
//             <Image src={image.urls.small} key={image.id} size="medium" bordered />
//           ))}
//         </Image.Group>
//         {/* <LazyLoad /> */}
  ...
  <div>
    ...
    <Container text>
      ...
      <p>
        ...
        ,
        <code>centered row</code>
        , or
        <code>centered column</code> to center the column contents inside the grid.
      </p>
